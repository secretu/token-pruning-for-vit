...
"""- name: {job_name}
  ...
  priority: high
  command:
  - bash run_joint_pruning_itp_bert6.sh {task} {sparsity} {location} {learning_rate} {reg_learning_rate} {sparsity_reg_loss_alpha} {warmup_epochs} {tag} {bin_num} {topk} {epochs} {eval_step}
"""
...
def main():
    ...
    parser.add_argument("--location", type=str, default="3,6,9")
