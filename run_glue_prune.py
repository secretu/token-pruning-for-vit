...
def main():
    ...
    if additional_args.include_padding:
        print("prune including padding")
        model.bert.encoder.include_padding = True
    else:
        print("prune on effective tokens only")
        model.bert.encoder.include_padding = False
